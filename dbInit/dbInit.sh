...
GRANT ALL PRIVILEGES ON ${YAMBA_DATABASE_DATABASE}.teamspeak_instances TO $YAMBA_DATABASE_USER;
GRANT ALL PRIVILEGES ON ${YAMBA_DATABASE_DATABASE}.instance_store TO $YAMBA_DATABASE_USER;
GRANT ALL PRIVILEGES ON ${YAMBA_DATABASE_DATABASE}.queues TO $YAMBA_DATABASE_USER;
