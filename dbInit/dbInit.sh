...
GRANT ALL PRIVILEGES ON ${YAMBA_DATABASE_DATABASE}.streams TO $YAMBA_DATABASE_USER;
GRANT ALL PRIVILEGES ON ${YAMBA_DATABASE_DATABASE}.songs TO $YAMBA_DATABASE_USER;
GRANT ALL PRIVILEGES ON ${YAMBA_DATABASE_DATABASE}.playlists TO $YAMBA_DATABASE_USER;
GRANT ALL PRIVILEGES ON ${YAMBA_DATABASE_DATABASE}.songs_to_playlists TO $YAMBA_DATABASE_USER;
