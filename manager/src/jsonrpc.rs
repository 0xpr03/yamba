...
use actix_web::{
    error::ErrorInternalServerError, middleware, web, Error as WebError, HttpRequest, HttpResponse,
    HttpServer,
};
...
pub fn create_server(
    ...
    actix_web::HttpServer::new(move || {
        ...
        actix_web::App::new()
            .data(state.clone())
            .wrap(middleware::Logger::new("manager::api::jsonrpc"))
            .wrap(SecurityModule::new(allowed_host))
            .service(
                web::resource("/").route(
                    web::post()
                        .guard(json_only)
