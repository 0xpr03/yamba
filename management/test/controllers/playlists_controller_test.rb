...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post playlists_url, params: { playlist: { author: @playlist.author, name: @playlist.name, source: @playlist.source } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { author: @playlist.author, name: @playlist.name, source: @playlist.source } }
